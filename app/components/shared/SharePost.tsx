...
export default function SharePost({ title, slug, description }: props) {
  ...
  const options = [
    {
      ...
      shareUrl: `https://twitter.com/intent/tweet?text=${encodeURIComponent(
        "Thank you @BlakvGhost for writing this post."
    ...
    },
    {
      ...
      shareUrl: `https://api.whatsapp.com/send?text=${encodeURIComponent(
        "Read this amazing article by Kabirou ALASSANE"
      )}.%0A%0A${title}%0A%0A${blog}${slug}`,
    },
  ];
  ...
  return (
    <section className="border-b dark:border-zinc-800 border-zinc-200 pb-10">
      <h3 className="text-xl font-semibold tracking-tight mb-4">Partager la publication</h3>
